              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="create_category" class="forms-sample" action="{{route('admin.category.update',$category->id)}}">
                      <input type="text" id="category_id" value="{{$category->id}}" hidden>
                        ...
                        <div class="col-sm-4" style="align-content: center;">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="status" id="statusRadios1" value="1" {{$category->status == 1 ? 'checked':''}}> Active <i class="input-helper"></i></label>
                          </div>
                        </div>
                        <div class="col-sm-5" style="align-content: center;">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="status" id="statusRadios2" value="2" {{$category->status == 2 ? 'checked':''}}> Inactive <i class="input-helper"></i></label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
